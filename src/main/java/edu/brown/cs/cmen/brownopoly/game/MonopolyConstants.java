...
public class MonopolyConstants {
  ...
  /* 0 */null, {2, 10, 30, 90, 250}, null, /* 1 */{4, 20, 60, 180, 450},
  /* 2 */null, null, {6, 30, 90, 270, 550}, null, /* 3 */{6, 30, 90, 270, 550},
  /* 4 */{8, 40, 100, 300, 600}, null, /* 5 */{10, 50, 150, 450, 750}, null,
  /* 6 */{10, 50, 150, 450, 750},/* 7 */{12, 60, 180, 500, 900}, null,
  /* 8 */{14, 70, 200, 550, 950}, null, /* 9 */{14, 70, 200, 550, 950},
  /* 10 */{16, 80, 220, 600, 1000}, null, /* 11 */{18, 90, 250, 700, 1050}, null,
  /* 12 */{18, 90, 250, 700, 1050},/* 13 */{20, 100, 300, 750, 1100}, null,
  /* 14 */{22, 110, 330, 800, 1150},/* 15 */{22, 110, 330, 800, 1150}, null,
  /* 16 */{24, 120, 360, 850, 1200}, null, /* 17 */{26, 130, 390, 900, 1275},
  /* 18 */{26, 130, 390, 900, 1275}, null, /* 19 */{28, 150, 450, 1000, 1400}, null, null,
  /* 20 */{35, 175, 500, 1100, 1500}, null, /* 21 */{50, 200, 600, 1400, 2000}};

  private static final int[][] PROPERTY_RENTS_4 = {
  /* 0 */null, {2, 10, 30, 90, 160, 250}, null, /* 1 */{4, 20, 60, 180, 320, 450},
  /* 2 */null, null, {6, 30, 90, 270, 400, 550}, null, /* 3 */{6, 30, 90, 270, 400, 550},
  /* 4 */{8, 40, 100, 300, 450, 600}, null, /* 5 */{10, 50, 150, 450, 625, 750}, null,
  /* 6 */{10, 50, 150, 450, 625, 750},/* 7 */{12, 60, 180, 500, 700, 900}, null,
  /* 8 */{14, 70, 200, 550, 750, 950}, null, /* 9 */{14, 70, 200, 550, 750, 950},
  /* 10 */{16, 80, 220, 600, 800, 1000}, null, /* 11 */{18, 90, 250, 700, 875, 1050}, null,
  /* 12 */{18, 90, 250, 700, 875, 1050},/* 13 */{20, 100, 300, 750, 925, 1100}, null,
  /* 14 */{22, 110, 330, 800, 975, 1150},
  /* 15 */{22, 110, 330, 800, 975, 1150}, null,
  /* 16 */{24, 120, 360, 850, 1025, 1200}, null,
  /* 17 */{26, 130, 390, 900, 1100, 1275},
  /* 18 */{26, 130, 390, 900, 1100, 1275}, null,
  /* 19 */{28, 150, 450, 1000, 1200, 1400}, null, null,
  /* 20 */{35, 175, 500, 1100, 1300, 1500}, null,
  /* 21 */{50, 200, 600, 1400, 1700, 2000}};
    ...
    public static final int[][] DEFAULT_BOARD_COLORS = {
            null, {75, 0, 130}, null, {75, 0, 130}, null, null, {135, 206, 235}, null, {135, 206, 235}, {135, 206, 235},
            null, {255, 0, 255}, null, {255, 0, 255}, {255, 0, 255}, null, {255, 165, 0}, null, {255, 165, 0}, {255, 165, 0},
            null, {255, 0, 0}, null, {255, 0, 0}, {255, 0, 0}, null, {255, 255, 0}, {255, 255, 0}, null, {255, 255, 0},
            null, {0, 128, 0}, {0, 128, 0}, null, {0, 128, 0}, null, null, {0, 0, 255}, null, {0, 0, 255}
    };

    public static final String[] DEFAULT_BOARD_NAMES = {
            ...
            "ILLINOIS AVENUE", "B. & O. AVENUE", "ATLANTIC AVENUE", "VENTNOR AVENUE", "WATER WORKS",
